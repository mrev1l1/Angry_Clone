...
SmallRectangleRenderer::SmallRectangleRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources,char* model) :
...
void SmallRectangleRenderer::CreateWindowSizeDependentResources()
{
...
void SmallRectangleRenderer::Update(DX::StepTimer const& timer)
{
	if (!m_tracking)
	{
...
void SmallRectangleRenderer::Rotate(float radians)
{
...
void SmallRectangleRenderer::Render()
{
...
void SmallRectangleRenderer::CreateDeviceDependentResources()
{
	...
	auto loadPSTask = DX::ReadDataAsync(L"SamplePixelShader.cso");
		...
		auto createCubeTask = (createPSTask && createVSTask).then([this]() {
				...
				ModelFileHandler mfh(modelPath);
				 const AngryClone::VertexPositionColor* testv = mfh.getVertices();
...
void SmallRectangleRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
...
void SmallRectangleRenderer::StartTracking()
{
	m_tracking = true;
}

// When tracking, the 3D cube can be rotated around its Y axis by tracking pointer position relative to the output screen width.
void SmallRectangleRenderer::TrackingUpdate(float positionX)
{
	if (m_tracking)
	{
...
void SmallRectangleRenderer::StopTracking()
{
	m_tracking = false;
}

Cube^ SmallRectangleRenderer::CreateRectangle()
{
...
SmallRectangleRenderer::~SmallRectangleRenderer()
{
}
