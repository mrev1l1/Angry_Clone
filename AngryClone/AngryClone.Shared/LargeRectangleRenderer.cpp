...
LargeRectangleRenderer::LargeRectangleRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void LargeRectangleRenderer::CreateWindowSizeDependentResources()
{
	...
	static const XMVECTORF32 eye = { -12.0f, 15.0f, -40.f, 0.f };//{ -30.0f, 0.7f, -30.0f, 0.0f };
...
void LargeRectangleRenderer::Update(DX::StepTimer const& timer)
{
	if (!m_tracking)
	{
...
void LargeRectangleRenderer::Rotate(float radians)
{
...
void LargeRectangleRenderer::Render()
{
...
void LargeRectangleRenderer::CreateDeviceDependentResources()
{
	...
	auto createCubeTask = (createPSTask && createVSTask).then([this]() {
		...
		ModelFileHandler mfh("C:\\Users\\Олександр\\AppData\\Local\\Packages\\a5f5ffab-88e8-40fd-8e9e-80a2994ded96_kqgv1awp48cbp\\LocalState\\largeRectangleModel.txt");
...
void LargeRectangleRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
...
void LargeRectangleRenderer::StartTracking()
{
	m_tracking = true;
}

// When tracking, the 3D cube can be rotated around its Y axis by tracking pointer position relative to the output screen width.
void LargeRectangleRenderer::TrackingUpdate(float positionX)
{
	if (m_tracking)
	{
...
void LargeRectangleRenderer::StopTracking()
{
	m_tracking = false;
}

Cube^ LargeRectangleRenderer::CreateRectangle()
{
...
LargeRectangleRenderer::~LargeRectangleRenderer()
{
}