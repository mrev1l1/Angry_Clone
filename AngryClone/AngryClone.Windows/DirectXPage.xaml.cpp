...
void DirectXPage::OnPointerPressed(Object^ sender, PointerEventArgs^ e)
{
	...
	deltaX = e->CurrentPoint->Position.X;
	deltaY = e->CurrentPoint->Position.Y;
}
...
void DirectXPage::OnPointerMoved(Object^ sender, PointerEventArgs^ e)
{
	...
	if (m_main->IsTracking())
	{
		...
		pos[0] = e->CurrentPoint->Position.X - deltaX;
		pos[1] = e->CurrentPoint->Position.Y - deltaY;
		m_main->TrackingUpdate(pos);
	}
}
